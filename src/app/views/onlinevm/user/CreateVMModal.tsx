    ...
    return <Modal size="large" open>
        ...
        <Modal.Content>
            ...
            {loaded && <Table>
                ...
                <Table.Body>
                    {_.zip(products, usedHours).map(([prod, hour], idx) => <Table.Row
            ...
            <Message info>
                ...
                <Message.Content>
                    ...
                    <p>对于同一种产品，同一个用户的不同订单之间，共享相同的计费时长。例如，如果用户创建了产品1的订单后使用了一个半小时，而后退还了这台服务器。而后又创建了产品产品1的订单，则计费从第3小时对应的档位开始。</p>
                </Message.Content>
            </Message>
        </Modal.Content>
        <Modal.Actions>
