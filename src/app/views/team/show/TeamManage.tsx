...
import { TeamDetail, TeamStatisticEntry } from "../client/types";
...
const TeamManage: React.FC<React.PropsWithChildren<TeamManageProps>> = (props) => {
    ...
    const refreshData = (async () => {
        try {
            ...
            for (const item of await teamClient.getTeamStatistics(props.team, endTime.minus({ days: duration }), endTime)) {
